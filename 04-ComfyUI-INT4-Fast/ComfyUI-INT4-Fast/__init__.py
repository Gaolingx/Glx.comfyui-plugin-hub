...
# This installation uses a locally compiled CUDA 12.8 comfy-kitchen extension,
# which has been runtime-tested on this machine. ComfyUI disables kitchen CUDA
# globally for prebuilt wheels below CUDA 13, so re-enable this verified build.
try:
    import comfy_kitchen as _ck
    import comfy_kitchen.backends.cuda._C  # noqa: F401
    _ck.registry.enable("cuda")
except Exception as e:
    logging.warning(f"Int4Fast: Local comfy-kitchen CUDA backend unavailable: {e}")
